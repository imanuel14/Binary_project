...
<div class="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <a href="{{ route('admin.users.index') }}" class="{{ request()->routeIs('admin.users') ? 'active' : '' }}">
          ...
          <!-- TAMBAHAN: Menu Data Jemaat -->
        <a href="{{ route('admin.jemaats.index') }}" class="{{ request()->routeIs('admin.jemaats.*') ? 'active' : '' }}">
            <i class="bi bi-people-fill me-2"></i> Data Jemaat
        </a>
        ...
        <a href="{{ route('admin.church-profile.edit') }}" class="{{ request()->routeIs('admin.church-profile.*') ? 'active' : '' }}">
            <i class="bi bi-building me-2"></i> Profil
        </a>
        <a href="{{ route('admin.galleries.index') }}" class="{{ request()->routeIs('admin.galleries.*') ? 'active' : '' }}">
            <i class="bi bi-images me-2"></i> Galery Kegiatan
        </a>
    </div>
